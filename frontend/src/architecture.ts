  ...
  tabs: [
    {
      ...
      body_es:
        'StockTwin simula una pila de acopio de extremo a extremo: los camiones descargan sobre una losa, la pila se relaja hasta su ángulo de reposo, la segregación granular por tamaño redistribuye el material a lo largo de cada avalancha, y un recuperador toma cortes que vuelven a mezclar las capas apiladas. Cada tonelada recuperada conserva el registro fraccionario de los eventos de deposición de los que proviene.\n\n'
    ...
    },
    {
      ...
      body_es:
        'Una aplicación de página única estática, sin backend. La ruta App ejecuta el motor en vivo sobre los controles; las cinco rutas de documentación son prosa; la ruta de foco se dibuja fuera del shell porque el encabezado y el pie son exactamente el cromo del que existe para escapar.\n\n'
    ...
    },
    {
      ...
      body_es:
        'Modelo de bloques a secuencia de extracción a flujo de camiones a pila a corte recuperado, con las ecuaciones en cada paso.\n\n'
    ...
    },
    {
      ...
      body_es:
        'contrato 1, ingesta: la puerta de trae-tus-propios-datos. Un registro de descargas de camion declara sus columnas, unidades y rangos, con una politica explícita de valores atipicos. Una fila que falla un rango duro se rechaza con una razón declarada; una que falla una verificación blanda se marca, se conserva, se cuenta y se dibuja con un indicador; nada se corrige en silencio, porque una fila corregida parece dato y no lo es. Se rechazan las filas fuera de orden temporal y las descargas fuera de la losa. La tabla qué muestra la página de Implementación se genera desde el codigo que aplica el contrato, de modo que documentación y comportamiento no pueden divergir.\n\n'
